...
play = get_image("images/play1.png")
forward = get_image("images/forward1.png")
back = get_image("images/back1.png")
folder = get_image("images/folder.png")
clear = get_image("images/clear.png")
...
class MusicPlayer():
    def __init__(self):
        ...
        self.volume = 1.0
        self.index = 0
        self.dynamic_play = get_image("images/play1.png")
    ...
    def play_function(self):
        ...
        try:
            ...
            self.started = True
            self.dynamic_play= get_image("images/pause1.png")
        except:
